...
namespace geo3dml {
	...
	public:
		...
		virtual double DoubleValue(const std::string& field, int targetIndex) const = 0;
		...
		virtual std::string TextValue(const std::string& field, int targetIndex) const = 0;
		...
		virtual int IntValue(const std::string& field, int targetIndex) const = 0;
		...
		virtual bool BooleanValue(const std::string& field, int targetIndex) const = 0;
