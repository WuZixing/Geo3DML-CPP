...
RectifiedGrid::RectifiedGrid(const geo3dml::Point3D& origin, const geo3dml::Vector3D& vecI, const geo3dml::Vector3D& vecJ, const geo3dml::Vector3D& vecK, int dimI, int dimJ, int dimK)
    : geo3dml::RectifiedGrid(origin, vecI, vecJ, vecK, dimI, dimJ, dimK) {
