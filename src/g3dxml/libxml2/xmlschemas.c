                           ...
                           xmlNodePtr node)
{
    ...
    * An instance of a datatype that is defined as 穊oolean?    * can have the following legal literals {true, false, 1, 0}.
    */
                                ...
                                xmlNodePtr node)
{
    ...
    */
        ...
        (refNs == pctxt->redef->refTargetNs))
    {
        ...
        * the 穉ctual value?of whose ref [attribute] is the same
        * as the 穉ctual value?of its own name attribute plus
                    ...
                    xmlNodePtr node)
{
    ...
    * then the 穝imple ur-type definition?"
    */
                         ...
                         xmlNodePtr node, int topLevel)
{
    ...
    /*
    * TargetNamespace:
    * SPEC "The 穉ctual value?of the targetNamespace [attribute]
    ...
    * <restriction> among its [children] ... the 穉ctual value?of whose
    * base [attribute] must be the same as the 穉ctual value?of its own
                ...
                xmlSchemaBucketPtr *bucket)
{
    ...
    */
    ...
    if (WXS_IS_BUCKET_IMPMAIN(type)) {
        ...
        * namespace, regardless of the 穉ctual value?of schemaLocation, but
                     ...
                     xmlNodePtr node)
{
    ...
    */
    ...
    if (namespaceName != NULL) {
        /*
        * 1.1 If the namespace [attribute] is present, then its 穉ctual value?        * must not match the 穉ctual value?of the enclosing <schema>'s
    ...
    */    
    if ((bucket == NULL) || (bucket->doc == NULL)) {
        if (type == XML_SCHEMA_SCHEMA_INCLUDE) {
            ...
            * satisfied:
            * SPEC src-include: "It is not an error for the 穉ctual value?of the
            ...
            * other than <annotation> then the 穉ctual value?of the
        ...
        */    
        if (bucket->origTargetNamespace != NULL) {          
            ...
            * "SII has a targetNamespace [attribute], and its 穉ctual
            * value?is identical to the 穉ctual value?of the targetNamespace
                ...
                */
                    ...
                    part && part->children)
                {
                            ...
                            ctxt->redef->refTargetNs))
                    {
                        ...
                        * some level the 穉ctual value?of whose ref
                        * [attribute] is the same as the 穉ctual value?of
                        ...
                        */
                            ...
                            ((WXS_PARTICLE(part))->maxOccurs != 1))
                        {
                            ...
                            /*
                            * SPEC src-redefine:
                            * (6.1.2) "The 穉ctual value?of both that
                          ...
                          xmlNodePtr node, xmlSchemaTypeType parentType)
{
    ...
    * the {content type} of the type definition 穜esolved?to by
    * the 穉ctual value?of the base [attribute]"
    */
        ...
        &(type->baseNs), &(type->base)) == 0)
    {
            ...
            (type->flags & XML_SCHEMAS_TYPE_GLOBAL))
        {
                ...
                (! xmlStrEqual(type->baseNs, type->targetNamespace)))
            {
                ...
                * REDEFINE: SPEC src-redefine (5)
                * "Within the [children], each <simpleType> must have a
                * <restriction> among its [children] ... the 穉ctual value?of
                * whose base [attribute] must be the same as the 穉ctual value?                * of its own name attribute plus target namespace;"
                */
                          ...
                          xmlNodePtr node, int topLevel)
{
    ...
    */
    ...
    if (IS_SCHEMA(child, "simpleContent")) {
        ...
        * for complex content restricting the 穟r-type definition? and the
                                  ...
                                  xmlSchemaParserCtxtPtr ctxt)
{
    ...
    if ((elemDecl->subtypes == NULL) && (elemDecl->namedType != NULL)) {
        ...
        /* (type definition) ... otherwise the type definition 穜esolved?        * to by the 穉ctual value?of the type [attribute] ...
        */
    ...
    if (elemDecl->substGroup != NULL) {
        ...
        */
        ...
        if (substHead == NULL) {
            ...
            * declaration 穜esolved?to by the 穉ctual value?            * of the substitutionGroup [attribute], if present"
            */
                                 ...
                                 xmlSchemaTypePtr type)
{
    ...
    * define the explicit members as the type definitions 穜esolved?    * to by the items in the 穉ctual value?of the memberTypes [attribute],
                            ...
                            xmlSchemaWildcardPtr curWild)
{
    ...
    */
    ...
    /*
    * 3 If both O1 and O2 are sets of (namespace names or 穉bsent?,
    ...
    * or 穉bsent?, then a pair of not and 穉bsent?must be the value.
    */
    if ((completeWild->negNsSet != NULL) &&
    ...
    if (((completeWild->negNsSet != NULL) &&
        ...
        if (nsFound && absentFound) {
            ...
            * name and 穉bsent? then any must be the value.
            */
            completeWild->any = 1;
            if (completeWild->nsSet != NULL) {
                xmlSchemaFreeWildcardNsSet(completeWild->nsSet);
            ...
            * but not 穉bsent? then a pair of not and 穉bsent?must
            * be the value.
            */
            if (completeWild->nsSet != NULL) {
                xmlSchemaFreeWildcardNsSet(completeWild->nsSet);
            ...
            /*
            * 5.3 If the set S includes 穉bsent?but not the negated
            ...
            * name or 穉bsent? then whichever of O1 or O2 is a pair of not
    ...
    if (((completeWild->negNsSet != NULL) &&
        ...
        while (cur != NULL) {
            if (cur->value == NULL) {
                /*
                * 6.1 If the set S includes 穉bsent? then any must be the
                * value.
                */
                completeWild->any = 1;
                if (completeWild->nsSet != NULL) {
        ...
        if (completeWild->negNsSet == NULL) {
            /*
            * 6.2 If the set S does not include 穉bsent? then a pair of not
            * and 穉bsent?must be the value.
            */
            if (completeWild->nsSet != NULL) {
                xmlSchemaFreeWildcardNsSet(completeWild->nsSet);
                completeWild->nsSet = NULL;
                            ...
                            xmlSchemaWildcardPtr curWild)
{
    ...
    * name or 穉bsent? and the other is a set of (namespace names or
    * 穉bsent?, then that set, minus the negated value if it was in
    * the set, minus 穉bsent?if it was in the set, must be the value.
    */
    ...
    /*
    * 4 If both O1 and O2 are sets of (namespace names or 穉bsent?,
    ...
    * is a negation of 穉bsent? then the one which is the negation
                          ...
                          xmlSchemaWildcardPtr super)
{
    ...
    */
    if (super->any)
        return (0);
    /*
    * 2.1 sub must be a pair of not and a namespace name or 穉bsent?
    ...
    */
    if ((sub->negNsSet != NULL) &&
        ...
        return (0);
    /*
    * 3.1 sub must be a set whose members are either namespace names or 穉bsent?
    */
    if (sub->nsSet != NULL) {
        /*
        ...
        */
        if (super->nsSet != NULL) {
            ...
            * 穉bsent?and that value must not be in sub's set.
            */
            cur = sub->nsSet;
            while (cur != NULL) {
                        ...
                        WXS_ATTRUSE_DECL_TNS(bcur)))
                {
                    ...
                    */
                        ...
                        WXS_ATTRUSE_TYPEDEF(bcur), 0) != 0)
                    {
                        ...
                        * defined in Type Derivation OK (Simple) (?.14.6)."
                        */
                        xmlSchemaPAttrUseErr4(pctxt,
                        ...
                        *
                        * 2.1.3.1 B's 積ffective value constraint?is
                        * 穉bsent?or default.
                        */
                        if ((bEffValue != NULL) &&
                            (effFixed == 1)) {
                            ...
                            /*
                            * 2.1.3.2 R's 積ffective value constraint?is
...
not_found:      
            if (!found) {
                ...
                * R's {attribute declaration} must be 穠alid?with respect
    ...
    if (wild != NULL) {
        ...
        */   
                ...
                xmlSchemaCheckCOSNSSubset(wild, baseWild))
        {
            ...
            * as defined by Wildcard Subset (?.10.6)."
            */
            xmlSchemaCustomErr4(ACTXT_CAST pctxt,
        ...
        /* 4.3 Unless the {base type definition} is the 穟r-type
    ...
    */
    if (WXS_IS_EXTENSION(type)) {       
        if (baseType->attributeWildcard != NULL) {
            /*
            * (3.2.2.1) "If the 穊ase wildcard?is non-穉bsent? then
            ...
            */
            if (type->attributeWildcard != NULL) {
                ...
                * and {annotation} are those of the 穋omplete wildcard?
                * and whose {namespace constraint} is the intensional union
                * of the {namespace constraint} of the 穋omplete wildcard?                * and of the 穊ase wildcard? as defined in Attribute
                * Wildcard Union (?.10.6)."
                */
                ...
                /*
                * (3.2.2.1.1) "If the 穋omplete wildcard?is 穉bsent?
                * then the 穊ase wildcard?"
                */
                type->attributeWildcard = baseType->attributeWildcard;
            }    
        } else {
            /*
            * (3.2.2.2) "otherwise (the 穊ase wildcard?is 穉bsent? the
            * 穋omplete wildcard"
            * NOOP
            */
        }
                             ...
                             int subset)
{
    ...
    */
    ...
    if (type->baseType == baseType) {
        /*
        * 2.2.1 D's 穊ase type definition?is B.
        */
        return (0);
    }
    /*
    * 2.2.2 D's 穊ase type definition?is not the 穟r-type definition?    * and is validly derived from B given the subset, as defined by this
    * constraint.
    */
    ...
    /*
    * 2.2.3 D's {variety} is list or union and B is the 穝imple ur-type
    * definition?
    */
                             ...
                             xmlSchemaTypePtr type)
{
    ...
    */
    /* Base type: If the datatype has been 穌erived?by 穜estriction?    * then the Simple Type Definition component from which it is 穌erived?
    * otherwise the Simple Type Definition for anySimpleType (?.1.6).
    */
    if (baseType == NULL) {
        /*
    ...
    */
    ...
    /*
    * 2 All simple type definitions must be derived ultimately from the 穝imple
    * ur-type definition (so?circular definitions are disallowed). That is, it
    * must be possible to reach a built-in primitive datatype or the 穝imple
    ...
    if (WXS_IS_ATOMIC(type)) {
        ...
        */
        ...
        if (WXS_IS_ANY_SIMPLE_TYPE(type->baseType)) {
            ...
            * A 穕ist?datatype can be 穌erived?from an 穉tomic?datatype
            * whose 穕exical space?allows space (such as string or anyURI)or
            * a 穟nion?datatype any of whose {member type definitions}'s
            * 穕exical space?allows space.
            */
        } else {
            /*
            ...
            * the empty set, as defined in Type Derivation OK (Simple) (?.14.6).
            */
            {
                ...
                do {
                    switch (facet->type) {
                        ...
                        case XML_SCHEMA_FACET_WHITESPACE:
                            ...
                            * The value of 穡hiteSpace?is fixed to the value collapse.
                            */
                        case XML_SCHEMA_FACET_PATTERN:
                        case XML_SCHEMA_FACET_ENUMERATION:
                            break;
        ...
        */
        ...
        /*
        * 3.3.1 If the {base type definition} is the 穝imple ur-type
        * definition?        */
        if (type->baseType->builtInType == XML_SCHEMAS_ANYSIMPLETYPE) {
            ...
            * as defined in Type Derivation OK (Simple) (?.14.6).
            */
            {
                            ...
                            xmlSchemaTypePtr type)
{
    ...
    * Definition Schema Components (?.14.6).
    */    
    if (WXS_IS_RESTRICTION(type)) {
        /*
                                   ...
                                   xmlSchemaValPtr *val)
{
    ...
    */
    if WXS_IS_COMPLEX(type) {
        ...
        * type}'s particle must be 積mptiable?as defined by
        * Particle Emptiable (?.9.6)."
        */
    ...
    * must be 穠alid?with respect to that definition as defined by String
    * Valid (?.14.4).
    *
    * AND
    *
    * 2.2.1 If the {content type} is a simple type definition, then the
    * string must be 穠alid?with respect to that simple type definition
    * as defined by String Valid (?.14.4).
    */
                             ...
                             xmlSchemaTypePtr type)
{
    ...
    * Schema Component (?.4.1), modulo the impact of Missing
    * Sub-components (?.3)."
    */
    if ((type->baseType != NULL) &&
    ...
    /*
    * SPEC (3) "Circular definitions are disallowed, except for the 穟r-type
    * definition? That is, it must be possible to reach the 穟r-type
                             ...
                             int set)
{
    ...
    */
    if (type->baseType == baseType)
        return (0);
    /*
    * SPEC (2.3.1) "D's {base type definition} must not be the 穟r-type
    * definition?"
    */
    if (WXS_IS_ANYTYPE(type->baseType))
        return (1);
                           ...
                           xmlSchemaTypePtr type)
{
    ...
    */
    if (WXS_IS_COMPLEX(base)) { 
        ...
        * constraint}, as defined by Wildcard Subset (?.10.6)."
        */
        ...
        if ((type->contentTypeDef != NULL) &&
            ...
            */
            if (base->contentType == XML_SCHEMA_CONTENT_EMPTY) {
                ...
                * complex type definition must be a 穠alid extension?                * of the {base type definition}'s particle, as defined
                * in Particle Valid (Extension) (?.9.6)."
                *
    ...
    if (base->builtInType == XML_SCHEMAS_ANYTYPE) {
        ...
        */
            ...
            (base->contentType == XML_SCHEMA_CONTENT_BASIC))
        {
            ...
            * set as defined in Type Derivation OK (Simple) (?.14.6)."
            *
            ...
            * and have a particle which is 積mptiable?as defined in
            * Particle Emptiable (?.9.6)."
            * PASS
            */
        } else {
        ...
        */
        if (base->contentType == XML_SCHEMA_CONTENT_EMPTY) {
            ...
            * which is 積mptiable?as defined in Particle Emptiable (?.9.6)."
            * PASS
            */
        } else {
            xmlSchemaPCustomErr(ctxt,
        ...
        * must be a 穠alid restriction?of the particle of the {content
                    ...
                    xmlSchemaTypePtr type)
{
    ...
    */
    ...
    if (! WXS_HAS_SIMPLE_CONTENT(type)) {
        ...
        * 穜esolved?to by the 穉ctual value?of the base [attribute]
        ...
        * following must be true:
        * 2.1 The type definition 穜esolved?to by the 穉ctual value?of the
    ...
    * Definition Schema Components (?.4.6);"
                                 ...
                                 xmlSchemaParticlePtr b)
{
    ...
    * occurrence range as defined by Occurrence Range OK (?.9.6)."
    */
                            ...
                            xmlSchemaParticlePtr b)
{
    ...
    /*
    * SPEC "For an element declaration particle to be a 穠alid restriction?    * of a wildcard particle all of the following must be true:"
    *
    * SPEC (1) "The element declaration's {target namespace} is 穠alid?    * with respect to the wildcard's {namespace constraint} as defined by
    * Wildcard allows Namespace Name (?.10.4)."
    */
                                    ...
                                    int isAnyTypeBase)
{
    ...
    * of B's {namespace constraint} as defined by Wildcard Subset (?.10.6)."
    */
    if (xmlSchemaCheckCOSNSSubset((xmlSchemaWildcardPtr) r->children,
        (xmlSchemaWildcardPtr) b->children))
        return (1);
    /*
    * SPEC (3) "Unless B is the content model wildcard of the 穟r-type
                                             ...
                                             xmlSchemaParticlePtr b)
{
    ...
    if ((r->children == NULL) || (r->children->children == NULL))
        return (-1);
    /*
    * SPEC "For a group particle to be a 穠alid restriction?of a
    * wildcard particle..."
    *
    * SPEC (1) "Every member of the {particles} of the group is a 穠alid
    * restriction?of the wildcard as defined by
    * Particle Valid (Restriction) (?.9.6)."
    */
                           ...
                           xmlSchemaParticlePtr b)
{
    ...
    if ((r->children == NULL) || (b->children == NULL) ||
        ...
        return (-1);
    /*
    * SPEC "For an all or sequence group particle to be a 穠alid
                                             ...
                                             xmlSchemaTypePtr type)
{
    ...
    * definition in the 積xplicit members?with the members of their
...
xmlSchemaTypeFixupWhitespace(xmlSchemaTypePtr type)
{
    ...
    */    
    ...
    /*
    * For all 穉tomic?datatypes other than string (and types 穌erived?
    * by 穜estriction?from it) the value of whiteSpace is fixed to 
    * collapse
    */
    {
    ...
    if (type->contentType == XML_SCHEMA_CONTENT_SIMPLE) {
        ...
        */
        if ((particle == NULL) ||
            ...
            if (type->flags & XML_SCHEMAS_TYPE_MIXED) {
                /*
                * SPEC (2.1.4) "If the 積ffective mixed?is true, then
        ...
        if (WXS_IS_RESTRICTION(type)) {
            ...
            */
            if (type->contentType == XML_SCHEMA_CONTENT_EMPTY) {
                /*
                * SPEC (3.2.1)
                * "If the 積ffective content?is empty, then the
                ...
                */
                        ...
                        XML_SCHEMA_TYPE_ALL))
                {
                    ...
                    */
                    ...
                    /*
                    * SPEC "followed by the 積ffective content?"
                    */
    ...
    */
    ...
    switch (facet->type) {
        ...
        case XML_SCHEMA_FACET_ENUMERATION: {
                ...
                * It is an 積rror?if any member of {value} is not in the
                * 穠alue space?of {base type definition}.
                *
                * minInclusive, maxInclusive, minExclusive, maxExclusive:
                * The value 穖ust?be in the
                * 穠alue space?of the 穊ase type?
                */
                /*
                                ...
                                xmlSchemaParserCtxtPtr ctxt)
{
    ...
    * (Schema Document) (?.15.3) is applied to a 稱Name?arising from
    * any <attributeGroup>s with a ref [attribute] among the [children],
    * it must not be the case that a 稱Name?is encountered at any depth
...
{  
    ...
    * Group Definition Schema Component (?.6.1), modulo the impact of
    * Missing Sub-components (?.3);"
    */
                               ...
                               xmlSchemaAttributePtr attr)
{
    ...
    * Declaration Schema Component (?.2.1), modulo the impact of
    * Missing Sub-components (?.3)."
    */
    ...
    if (attr->defValue != NULL) {
        ...
        * representation of its value must be 穠alid?with respect
        * to the {type definition} as defined in String Valid (?.14.4)."
                               ...
                               xmlSchemaElementPtr elemDecl)
{
    ...
    * Declaration Schema Component (?.3.1), modulo the impact of Missing
    * Sub-components (?.3)."
    */
    if (WXS_SUBST_HEAD(elemDecl) != NULL) {
        ...
        /*
        * SPEC (3) "If there is a non-穉bsent?{substitution group
        ...
        * affiliation}, as defined in Type Derivation OK (Complex) (?.4.6)
        * (if the {type definition} is complex) or as defined in
        * Type Derivation OK (Simple) (?.14.6) (if the {type definition} is
        * simple)."
        *
    ...
    */
    if ((elemDecl->value != NULL) &&
        ...
        * representation of its value must be 穠alid?with respect to the
                             ...
                             xmlSchemaElementPtr elemDecl)
{
        ...
        return;
    {
        ...
        * Substitution Group OK (Transitive) (?.3.6)."
        */
        ...
        switch (WXS_PARTICLE_TERM(cur)->type) {
            ...
            case XML_SCHEMA_TYPE_ELEMENT:
                if (search == 0) {
                    ...
                    * contained model group, recursively) or 穒mplicitly?                    * two or more element declaration particles with
...
{   
    ...
    while (x != NULL) {
        ...
        /*
        * (1) if a datatype T' is 穌erived?by 穜estriction?from an
        * atomic datatype T then the 穠alue space?of T' is a subset of
        * the 穠alue space?of T. */
        /*
        * (2) if datatypes T' and T'' are 穌erived?by 穜estriction?        * from a common atomic ancestor T then the 穠alue space穝 of T'
        * and T'' may overlap.
        */
        if (ptx != pty)
            return(0);
                             ...
                             xmlSchemaAttributeUsePtr use)
{
    ...
    * Component (?.5.1), modulo the impact of Missing
    * Sub-components (?.3)."
    */
                                   ...
                                   xmlSchemaParserCtxtPtr ctxt)
{
    ...
    * type definition 穜esolved?to by the 穉ctual value?of the type
    * [attribute], if present, otherwise the 穝imple ur-type definition?
    */
    ...
    do {
        ...
        */
        ...
        if (prev == NULL) {
            ...
            /*
            * SPEC src-redefine:
            * (6.2.1) "The 穉ctual value?of its own name attribute plus
            * target namespace must successfully 穜esolve?to a model
            * group definition in I."
            * (7.2.1) "The 穉ctual value?of its own name attribute plus
            * target namespace must successfully 穜esolve?to an attribute
            * group definition in I."
    ...
    do {
        ...
        switch (item->type) {
            ...
            case XML_SCHEMA_TYPE_GROUP:
                ...
                * Group Definition Schema Components (?.7.2) must be a
                * 穠alid restriction?of the {model group} of that model
            ...
            case XML_SCHEMA_TYPE_ATTRIBUTEGROUP:
                ...
                * Components (?.6.2) must be 穠alid restrictions?of the
                ...
                * (?.4.6) (where references to the base type definition are
...
#define FIXHFAILURE if (pctxt->err == XML_SCHEMAP_INTERNAL) goto exit_failure;
    ...
    * Definition Schema Components (?.7.2) must be a 穠alid
    * restriction?of the {model group} of that model group definition
    * in I, as defined in Particle Valid (Restriction) (?.9.6)."
    */
    ...
    if (type->type == XML_SCHEMA_TYPE_BASIC) {
        ...
        */
        if ((type->builtInType == XML_SCHEMAS_STRING) ||
            ...
            /*
            * For all 穉tomic?datatypes other than string (and types 穌erived?            * by 穜estriction?from it) the value of whiteSpace is fixed to
            * collapse
            ...
            if ((key == NULL) && (vctxt->inode->val == NULL)) {
                ...
                */
                ...
                if (keySeq == NULL) {   
                    ...
                    * 3 For each node in the 穞arget node set?all
...
create_key:
            ...
            * then no two members of the 穛ualified node set?have
            * 穔ey-sequences?whose members are pairwise equal, as
...
selector_key_error:
            {
                xmlChar *str = NULL;
                /*
                * 4.2.1 (KEY) The 穞arget node set?and the 
                * 穛ualified node set?are equal, that is, every 
                * member of the 穞arget node set?is also a member
                * of the 穛ualified node set?and vice versa.
                */
                xmlSchemaCustomErr(ACTXT_CAST vctxt, 
                    XML_SCHEMAV_CVC_IDC, NULL,
                    WXS_BASIC_CAST idc,
...
#define NORMALIZE(atype) \
    ...
    * the empty set, as defined in Type Derivation OK (Simple) (?.14.6), then
    * the string must be a 穌eclared entity name?
    */
    /*
    * 2.2 If The definition is ENTITIES or is validly derived from ENTITIES
    * given the empty set, as defined in Type Derivation OK (Simple) (?.14.6),
    * then every whitespace-delimited substring of the string must be a 穌eclared
    * entity name?
    */
    /*
    ...
    */
    ...
    if (WXS_IS_ANY_SIMPLE_TYPE(type) || WXS_IS_ATOMIC(type)) {
        ...
        /*
        * SPEC (1.2.1) "if {variety} is 穉tomic?then the string must 穖atch?        * a literal in the 穕exical space?of {base type definition}"
        */
        /*
        ...
        */
        ...
        /* 1.2.2 if {variety} is 穕ist?then the string must be a sequence
        * of white space separated tokens, each of which 穖atch積s a literal
        * in the 穕exical space?of {item type definition}
        */
        /*
        ...
        */
        ...
        /*
        * TODO: For all datatypes 穌erived?by 穟nion? whiteSpace does
        * not apply directly; however, the normalization behavior of 穟nion?        * types is controlled by the value of whiteSpace on that one of the
        * 穖emberTypes?against which the 穟nion?is successfully validated.
        *
        ...
        */
        ...
        /*
        * 1.2.3 if {variety} is 穟nion?then the string must 穖atch?a
        * literal in the 穕exical space?of at least one member of
        ...
        */
        if ((ret == 0) && (type->flags & XML_SCHEMAS_TYPE_HAS_FACETS)) {
            /*
            * The normalization behavior of 穟nion?types is controlled by
            * the value of whiteSpace on that one of the 穖emberTypes?            * against which the 穟nion?is successfully validated.
            */
    ...
    if (iattr == NULL)
        ...
        *localType = xmlSchemaGetType(vctxt->schema, local, nsName);
        ...
        if (elemDecl != NULL) {
            ...
            * "The 穕ocal type definition?must be validly
...
xmlSchemaVAttributesComplex(xmlSchemaValidCtxtPtr vctxt)
{
    ...
    /*
    * SPEC (cvc-attribute)
    * (1) "The declaration must not be 穉bsent?(see Missing
    * Sub-components (?.3) for how this can fail to be
    * the case)."
    ...
    */
    ...
    for (i = 0; i < nbUses; i++) {
        ...
        for (j = 0; j < nbAttrs; j++) {
            ...
            * item's [namespace name] (where an 穉bsent?{target namespace}
            * is taken to be identical to a [namespace name] with no value),
            * then the attribute information must be 穠alid?with respect
            * to that attribute use as per Attribute Locally Valid (Use)
            * (?.5.4). In this case the {attribute declaration} of that
            * attribute use is the 穋ontext-determined declaration?for the
            * attribute information item with respect to Schema-Validity
            * Assessment (Attribute) (?.2.4) and
            * Assessment Outcome (Attribute) (?.2.5).
            */
        ...
        */
        for (i = 0; i < nbAttrs; i++) {
            ...
            */
            ...
            /*
            * SPEC (cvc-complex-type)
            * (3.2.2) "The attribute information item must be 穠alid?with
            * respect to it as defined in Item Valid (Wildcard) (?.10.4)."
            *
            * SPEC Item Valid (Wildcard) (cvc-wildcard)
            * "... its [namespace name] must be 穠alid?with respect to
            ...
            if (xmlSchemaCheckCVCWildcardNamespace(type->attributeWildcard,
                ...
                */
                ...
                if (iattr->decl != NULL) {
                    ...
                    * applied and whose 穠alidation?resulted in a
                    * 穋ontext-determined declaration?of mustFind or no
                    * 穋ontext-determined declaration?at all, and whose
                    * [local name] and [namespace name] resolve (as
                    * defined by QName resolution (Instance) (?.15.4)) to
                    ...
                    */
                    ...
                    if (xmlSchemaIsDerivedFromBuiltInType(
                        ...
                        */
                        ...
                        /*
                        * SPEC (cvc-complex-type)
                        * (5.2) "If 穡ild IDs?is non-empty, there must not
    ...
    */
    for (i = 0; i < vctxt->nbAttrInfos; i++) {
        ...
        */
        ...
        /*
        * SPEC (cvc-attribute)
        * (3) "The item's 穘ormalized value?must be locally 穠alid?        * with respect to that {type definition} as per 
        * String Valid (?.14.4)."
        *
        ...
        */
        ...
        if (fixed) {        
            ...
            * "For an attribute information item to be穠alid?            * with respect to an attribute use its *normalized*
...
character_content:
    ...
    */
    if ((inode->decl->value != NULL) &&
        ...
        /*
        * cvc-elt (3.3.4) : 5.1.1 
        * If the 穉ctual type definition?is a 穕ocal type definition?        * then the canonical lexical representation of the {value constraint}
        * value must be a valid default for the 穉ctual type definition?as 
        * defined in Element Default Valid (Immediate) (?.3.6). 
        */
        /* 
        ...
        * 穘ormalized value?must be 穠alid?with respect to the 
        * 穉ctual type definition?as defined by Element Locally Valid (Type)
        * (?.3.4).
        */          
        if (WXS_IS_SIMPLE(inode->typeDef)) {
            ret = xmlSchemaVCheckINodeDataType(vctxt,
...
default_psvi:
        ...
        */
        ...
        /*
        * 5.2.1 The element information item must be 穠alid?with respect 
        * to the 穉ctual type definition?as defined by Element Locally 
        * Valid (Type) (?.3.4).
        */      
        if (WXS_IS_SIMPLE(inode->typeDef)) {
             /*
            ...
            * (Element) (?.3.4) did not apply, then the 穘ormalized value?            * must be 穠alid?with respect to the type definition as defined
            * by String Valid (?.14.4).
            */      
            ret = xmlSchemaVCheckINodeDataType(vctxt,
                    inode, inode->typeDef, inode->value);
        } else if (WXS_HAS_SIMPLE_CONTENT(inode->typeDef)) {
            ...
            * 穠alid?with respect to the type definition as per
            * Element Locally Valid (Complex Type) (?.4.4);"
            *
            * SPEC (cvc-complex-type) (2.2)
            * "If the {content type} is a simple type definition, ... 
            * the 穘ormalized value?of the element information item is
            * 穠alid?with respect to that simple type definition as
            * defined by String Valid (?.14.4)."
            */
            ret = xmlSchemaVCheckINodeDataType(vctxt,
            ...
            if (inode->flags &
                ...
                */              
                if (WXS_HAS_MIXED_CONTENT(inode->typeDef)) {
                    /*
                    * 5.2.2.2.1 If the {content type} of the 穉ctual type 
                    ...
                    */             
                    ...
                    /*
                    * 5.2.2.2.2 If the {content type} of the 穉ctual type 
...
end_elem:
    ...
    */    
    ...
    /*
    * MAYBE TODO:
    * SPEC (6) "The element information item must be 穠alid?with
    * respect to each of the {identity-constraint definitions} as per
    * Identity-constraint Satisfied (?.11.4)."
    */
    /*
    ...
    */
    ...
    /*
    * VAL TODO: 7 If the element information item is the 穠alidation root? it must be 
    * 穠alid?per Validation Root Valid (ID/IDREF) (?.3.4).
    */
    return (ret);
    ...
    */
        ...
        if (vctxt->inode->decl == NULL) {
            ...
            */
            ...
            if (iattr != NULL) {
                 ...
                 *
                 * SPEC (cvc-assess-elt)
                 * "If the item cannot be 穝trictly assessed? [...]
                 * an element information item's schema validity may be laxly
                 * assessed if its 穋ontext-determined declaration?is not
                 * skip by 穠alidating?with respect to the 穟r-type
                 * definition?as per Element Locally Valid (Type) (?.3.4)."
                */
                vctxt->inode->typeDef =
                    xmlSchemaGetBuiltInType(XML_SCHEMAS_ANYTYPE);
            }
    ...
    switch (ptype->contentType) {
        ...
        case XML_SCHEMA_CONTENT_ELEMENTS: {
            ...
            * order, is 穠alid?with respect to the {content type}'s
